class Security {
    ...
    constructor(){
        ...
        this.access1.mouseClicked(() => {
          this.access1.value('');//añadiendo detalles
        });
        ...
        this.access2.mouseClicked(() => {
            this.access2.value('');//añadiendo detalles
          });
        ...
        this.access3.mouseClicked(() => {
            this.access3.value('');//añadiendo detalles
          });
